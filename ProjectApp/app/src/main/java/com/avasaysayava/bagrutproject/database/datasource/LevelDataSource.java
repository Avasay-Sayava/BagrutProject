...
public class LevelDataSource extends DataSource {
    ...
    public int getRankByTime(String time) {
        ...
        Cursor cursor = this.database.rawQuery("SELECT " + this.COLUMN_NAME + " FROM " + DatabaseContract.UserEntry.TABLE_NAME + " WHERE " + this.COLUMN_NAME + " IS NOT NULL ORDER BY " + this.COLUMN_NAME + ", " + DatabaseContract.UserEntry.COLUMN_UUID + " ASC", null);
    ...
    public void updateTimeByUUID(String time, String uuid) {
        ...
        values.put(this.COLUMN_NAME, time);
