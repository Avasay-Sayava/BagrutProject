    ...
    public WallsMap(Game game, float x, float y) {
        super(
                ...
                new List[][]{
                        ...
                        new List[]{},
                        new List[]{
                                Collections.singletonList(game.wallsTileSet.getTile(74).withZ(1)),
                                Collections.singletonList(game.wallsTileSet.getTile(75).withZ(1)),
                                Collections.singletonList(game.wallsTileSet.getTile(76).withZ(1)),
                                Collections.singletonList(game.wallsTileSet.getTile(77).withZ(1)),
                                Collections.singletonList(game.wallsTileSet.getTile(78).withZ(1)),
                                Collections.singletonList(game.wallsTileSet.getTile(79).withZ(1)),
                                Collections.singletonList(game.wallsTileSet.getTile(80).withZ(1)),
                                Collections.singletonList(game.wallsTileSet.getTile(81).withZ(1)),
