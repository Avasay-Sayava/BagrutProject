...
public class PropsTileSet extends TileSet {
    ...
    protected Tile[] getTileArray() {
        ...
        tiles[25] = getTile(3, 60, 7, 5, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileSound.WALL);
        ...
        reg = new Collision(Path.polygon(new PointF(3, 14), new PointF(28, 14), new PointF(28, 28), new PointF(3, 28)));
        tiles[28] = getTile(3, 28, 7, 6, 1, 1, 32, reg, Collision.empty, Collision.empty, TileSound.WALL);
