...
public class StructuresTileSet extends TileSet {
    ...
    protected Tile[] getTileArray() {
        ...
        tiles[3] = getTile(24, 7, 4, 1, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);
        ...
        reg = new Collision(new Path(new PointF(7, -1), new PointF(7, 32)));
        down = new Collision(new Path(new PointF(2, -1), new PointF(2, 32)));
        tiles[13] = getTile(0, 0, 1, 2, 1, 1, 32, reg, Collision.empty, down, TileType.WALL);

        reg = new Collision(new Path(new PointF(24, -1), new PointF(24, 32)));
        down = new Collision(new Path(new PointF(29, -1), new PointF(29, 32)));
        tiles[14] = getTile(24, 0, 3, 2, 1, 1, 32, reg, Collision.empty, down, TileType.WALL);
        ...
        reg = new Collision(new Path(new PointF(7, -1), new PointF(7, 32)));
        down = new Collision(new Path(new PointF(2, -1), new PointF(2, 32)));
        tiles[18] = getTile(0, 0, 9, 2, 1, 1, 32, reg, Collision.empty, down, TileType.WALL);

        reg = new Collision(new Path(new PointF(24, -1), new PointF(24, 32)));
        down = new Collision(new Path(new PointF(29, -1), new PointF(29, 32)));
        tiles[19] = getTile(24, 0, 10, 2, 1, 1, 32, reg, Collision.empty, down, TileType.WALL);
        ...
        tiles[22] = getTile(2, 0, 1, 3, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);
        ...
        tiles[24] = getTile(0, 0, 3, 3, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(7, -1), new PointF(7, 32)));
        down = new Collision(new Path(new PointF(2, -1), new PointF(2, 32)));
        tiles[25] = getTile(0, 0, 9, 3, 1, 1, 32, reg, Collision.empty, down, TileType.WALL);

        reg = new Collision(new Path(new PointF(24, -1), new PointF(24, 32)));
        down = new Collision(new Path(new PointF(29, -1), new PointF(29, 32)));
        tiles[26] = getTile(24, 0, 10, 3, 1, 1, 32, reg, Collision.empty, down, TileType.WALL);

        reg = new Collision(new Path(new PointF(2, -1), new PointF(2, 32)));
        tiles[27] = getTile(2, 0, 12, 3, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(29, -1), new PointF(29, 32)));
        tiles[28] = getTile(0, 0, 13, 3, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(2, -1), new PointF(2, 31), new PointF(32, 31)));
        tiles[29] = getTile(2, 0, 1, 4, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);
        ...
        tiles[31] = getTile(0, 0, 3, 4, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);
        ...
        reg = new Collision(new Path(new PointF(2, -1), new PointF(2, 31), new PointF(32, 31)));
        tiles[34] = getTile(2, 0, 12, 4, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(-1, 31), new PointF(29, 31), new PointF(29, -1)));
        tiles[35] = getTile(0, 0, 13, 4, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);
        ...
        tiles[58] = getTile(0, 31, 1, 9, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.WALL);

        tiles[59] = getTile(0, 31, 2, 9, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.WALL);

        tiles[60] = getTile(0, 31, 4, 9, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.WALL);

        tiles[61] = getTile(0, 31, 5, 9, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.WALL);

        tiles[62] = getTile(0, 63, 8, 9, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.WALL);

        tiles[63] = getTile(0, 63, 9, 9, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.WALL);

        tiles[64] = getTile(0, 63, 11, 9, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.WALL);

        tiles[65] = getTile(0, 63, 12, 9, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(-1, 31), new PointF(32, 31)));
        tiles[66] = getTile(0, 31, 1, 10, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(-1, 31), new PointF(32, 31)));
        tiles[67] = getTile(0, 31, 2, 10, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(-1, 31), new PointF(32, 31)));
        tiles[68] = getTile(0, 31, 4, 10, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(-1, 31), new PointF(32, 31)));
        tiles[69] = getTile(0, 31, 5, 10, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(-1, 31), new PointF(16, 31), new PointF(16, 27), new PointF(-1, 27)));
        tiles[70] = getTile(0, 31, 8, 10, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(32, 27), new PointF(15, 27), new PointF(15, 31), new PointF(32, 31)));
        tiles[71] = getTile(0, 31, 9, 10, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(-1, 31), new PointF(16, 31), new PointF(16, 27), new PointF(-1, 27)));
        tiles[72] = getTile(0, 31, 11, 10, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(32, 27), new PointF(15, 27), new PointF(15, 31), new PointF(32, 31)));
        tiles[73] = getTile(0, 31, 12, 10, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        tiles[74] = getTile(0, 0, 1, 12, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[75] = getTile(0, 0, 2, 12, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[76] = getTile(0, 0, 3, 12, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[77] = getTile(0, 0, 4, 12, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[78] = getTile(0, 0, 5, 12, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[79] = getTile(0, 0, 6, 12, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[80] = getTile(0, 0, 7, 12, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[81] = getTile(0, 0, 8, 12, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        reg = new Collision(new Path(new PointF(32, 3), new PointF(24, 3), new PointF(24, 32)));
        tiles[82] = getTile(24, 7, 9, 12, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(-1, 3), new PointF(7, 3), new PointF(7, 32)));
        tiles[83] = getTile(0, 7, 10, 12, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(-1, 3), new PointF(7, 3), new PointF(7, 32)));
        tiles[84] = getTile(0, 7, 11, 12, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        tiles[85] = getTile(0, 0, 1, 13, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[86] = getTile(0, 0, 2, 13, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[87] = getTile(0, 0, 3, 13, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[88] = getTile(0, 0, 5, 13, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[89] = getTile(0, 0, 6, 13, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[90] = getTile(0, 0, 7, 13, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        reg = new Collision(new Path(new PointF(31, -1), new PointF(31, 32)));
        top = new Collision(new Path(new PointF(24, -1), new PointF(24, 32)));
        tiles[91] = getTile(24, 0, 9, 13, 1, 1, 32, reg, top, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(0, -1), new PointF(0, 32)));
        top = new Collision(new Path(new PointF(7, -1), new PointF(7, 32)));
        tiles[92] = getTile(0, 0, 10, 13, 1, 1, 32, reg, top, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(0, -1), new PointF(0, 32)));
        top = new Collision(new Path(new PointF(7, -1), new PointF(7, 32)));
        tiles[93] = getTile(0, 0, 11, 13, 1, 1, 32, reg, top, Collision.empty, TileType.WALL);

        tiles[94] = getTile(0, 0, 1, 14, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[95] = getTile(0, 0, 2, 14, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[96] = getTile(0, 0, 3, 14, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[97] = getTile(0, 0, 5, 14, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[98] = getTile(0, 0, 6, 14, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        tiles[99] = getTile(0, 0, 7, 14, 1, 1, 32, Collision.empty, Collision.empty, Collision.empty, TileType.STAIR);

        reg = new Collision(new Path(new PointF(24, -1), new PointF(24, 31), new PointF(31, 31), new PointF(31, -1)));
        tiles[100] = getTile(24, 0, 9, 14, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(0, -1), new PointF(0, 31), new PointF(7, 31), new PointF(7, -1)));
        tiles[101] = getTile(0, 0, 10, 14, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);

        reg = new Collision(new Path(new PointF(0, -1), new PointF(0, 31), new PointF(7, 31), new PointF(7, -1)));
        tiles[102] = getTile(0, 0, 11, 14, 1, 1, 32, reg, Collision.empty, Collision.empty, TileType.WALL);
